<script>
	...
	export let fullname = {};
	export let email = {};
	export let checkbox_text = '';
	export let log_in_button = {};
	export let sign_up_button = {};
</script>

<section class="sign-up pt-md-20 pt-18 pb-md-20 pb-10">
	<div class="container">
		<div class="row">
			<div class="col-xxl-7 col-lg-8 mx-auto">
				<div class="sign-up-body">
					...
					<form class="sign-up-items row gy-4 gx-3">
						<div class="col-md-12">
